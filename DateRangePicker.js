    ...
    function (qlik, $, moment, CalendarSettings) {
        ...
        return {
            ...
            paint: function ($element, layout) {
                ...
                var todayDate = moment(layout.props.todayDate,"MM/DD/YYYY");
                ...
                html += '<div id="' + dateRangeId + '" class="bootstrap_inside pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 60%; height 100%">'
                ...
                if (layout.props.CustomRangesEnabled) {
                    ...
                    rangesLiteral[layout.props.today] = [ moment(todayDate),  moment(todayDate)];
                    rangesLiteral[layout.props.yesterday] = [moment(todayDate).subtract(1, 'days'), moment(todayDate).subtract(1, 'days')];
                    rangesLiteral[layout.props.lastXDays.replace("$", "7")] = [moment(todayDate).subtract(6, 'days'), moment(todayDate)];
                    rangesLiteral[layout.props.lastXDays.replace("$", "30")] = [moment(todayDate).subtract(29, 'days'), moment(todayDate)];
                    rangesLiteral[layout.props.thisMonth] = [moment(todayDate).startOf('month'), moment(todayDate).endOf('month')];
                    rangesLiteral[layout.props.lastMonth] = [moment(todayDate).subtract(1, 'month').startOf('month'), moment(todayDate).subtract(1, 'month').endOf('month')];
                    rangesLiteral[layout.props.thisQuarter] = [moment(todayDate).startOf('quarter'), moment(todayDate).endOf('quarter')];
                    rangesLiteral[layout.props.lastQuarter] = [moment(todayDate).subtract(1, 'quarter').startOf('quarter'), moment(todayDate).subtract(1, 'quarter').endOf('quarter')];
                    rangesLiteral[layout.props.thisYear] = [moment(todayDate).startOf('year'), moment(todayDate).endOf('year')];
                    rangesLiteral[layout.props.lastYear] = [moment(todayDate).subtract(1, 'year').startOf('year'), moment(todayDate).subtract(1, 'year').endOf('year')];
                }
